...
while starship_num <= starship_num_last:
    ...
    fill_table_starships = f"INSERT INTO starships (name, model, manufacturer, cargo_capacity) VALUES ('{starship_name}', '{starship_model}', '{starship_manufacturer}', '{starship_cargo_capacity}');"
